...
public class UserHeadImage {
    ...
    static{
        headImg = new HashMap<>();
        headImg.put(0, R.drawable.r8);
        headImg.put(1, R.drawable.r8);
        headImg.put(2, R.drawable.r8);
        headImg.put(3, R.drawable.r8);
        headImg.put(4, R.drawable.r8);
        headImg.put(5, R.drawable.r8);
        headImg.put(6, R.drawable.r8);
        headImg.put(7, R.drawable.r8);
        headImg.put(8, R.drawable.r8);
        headImg.put(9, R.drawable.r8);
        headImg.put(10, R.drawable.r8);
        headImg.put(11, R.drawable.r8);
        headImg.put(12, R.drawable.r8);
